 ...
 * About:        A model class that handle  page's  model operation
 * Copyright:  (C) 2019
...
public function get_special_page($slug)
{
...
public function insert_click($arr)
{

 $this->db->insert('clicks',$arr);
...
public function insert_contact_l()
{
...
'time' => time()
  ...
  $this->db->insert('cmessages',$contact);
